...
describe("get checkout session endpoint", () => {
  let endpoint: string;
  ...
  */
  ...
  it("should throw error when session doesnt exist", async () => {});
  it("should throw error when given address is not owner of the token", async () => {});
  it("should return payment session details", async () => {});
});
